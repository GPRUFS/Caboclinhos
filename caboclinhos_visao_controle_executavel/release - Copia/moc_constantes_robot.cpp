...
#include "../../VisionSystem_ULTIMATE_QT/constantes_robot.h"
...
void Constantes_robot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Constantes_robot *_t = static_cast<Constantes_robot *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject Constantes_robot::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Constantes_robot.data,
      qt_meta_data_Constantes_robot,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Constantes_robot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Constantes_robot.stringdata0))
        return static_cast<void*>(const_cast< Constantes_robot*>(this));
